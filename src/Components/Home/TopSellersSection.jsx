...
export default function TopSellersSection() {
  ...
  return (
    <section className="w-full overflow-x-hidden py-10 px-12">
        ...
        <div className="flex justify-between items-center flex-wrap pt-16 gap-6">
        {
            ...
            return(
                <div className="flex-1 basis-[250px] md:w-1/4 " key={item.title}>
                  <Link to={`/product/${item.id}?name=${item.title}`} className="grid place-items-center">
                    ...
                    <div className="mt-5 mx-auto overflow-hidden text-center w-[80%] lg:w-[80%]">
