  ...
  return (
    <>
      <div className="w-full h-[200px] relative about-banner">
        <h1 className="absolute left-5 md:left-24 bottom-10 text-white text-[25px] family-poppins font-[300]">About Northstar</h1>
      </div>
      <section className="text-gray-600 body-font">
        <h1 className="text-4xl font-medium title-font text-gray-900 mt-24 text-center">Founders</h1>
      ...
      <section className="text-gray-600 body-font px-5 md:px-20">
